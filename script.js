// This script uses the d3.json() method to gather the information

// Link to databases
const KickstarterPledgesData = 'https://cdn.freecodecamp.org/testable-projects-fcc/data/tree_map/kickstarter-funding-data.json';
...
let data; // video games sales Data

// Get Data =======================================
d3.json(VideoGameSalesData).then((dataBase, error) => {
    if(error) {
        console.log(error)
    }else {
        data = dataBase;
